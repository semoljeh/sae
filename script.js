...
function createAyatCardQuran(ayat, nomorSurah) {
    ...
    return `
        <div class="ayat-card">
            ...
            <div class="ayat-arabic">${ayat.teksArab.replace(/ࣖ/g, '<span style="font-family: \'Arial\', sans-serif; font-size: 0.33em; color: #007A78; position: relative; bottom: 0.6em; margin-right: 5px;"> ؏ </span>')}</div>
